...
作成した Skill.md の内容も、作品とは別のタブで記録できます。
...
- Skill.md のフォルダ名、作成日、保存場所、呼出プロンプト、特徴、本文を登録
- Skill一覧から登録済みSkillの詳細を確認
...
- Skill一覧画面: `http://127.0.0.1:5001/skills`
- Skill登録画面: `http://127.0.0.1:5001/skills/new`
